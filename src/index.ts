...
const profileForm = document.forms.namedItem(
  "profile-form"
) as HTMLFormElement;

const nameInput = profileForm.elements.namedItem("name") as HTMLInputElement;

const descriptionInput = profileForm.elements.namedItem(
  "description"
) as HTMLInputElement;

const addCardForm = document.forms.namedItem("add-card-form") as HTMLFormElement;
